...
const version = [2, 3000, 1047978911];
...
export const DONATE_URL = 'https://www.npmjs.com/package/@rexxhayanasi/elaina-baileys';
export const LIBRARY_NAME = 'rexxhayanasi/elaina-baileys';
...
export const MAX_OUTBOUND_RESEND_ENTRIES = 512;
export const MEMBER_LABEL_MAX_LENGTH = 30;
export const DEFAULT_CACHE_MAX_KEYS = 20000;

export const PAIRING_RESPONSE_GRACE_MS = 30000;
export const DEFAULT_CONNECTION_CONFIG = {
    ...
    ackRetryDelayMs: 750,
    maxAckRetryCount: 3,
    maxRetryQueueSize: 64,
    pairingCodeTimeoutMs: 180000,
